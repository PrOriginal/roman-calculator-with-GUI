...
SMALL_FONT_STYLE = ("Courier", 16, "bold")
...
class Calculator:
    def __init__(self):
        ...
        self.roman_nums = {1: "I", 2: "II", 3: "III", 4: "IV", 5: "V", 6: "VI", 7: "VII", 8: "VIII", 9: "IX", 10: "X", 20: "XX", 30: "XXX", 40: "XL", 50: "L", 60: "LX",
    ...
    def arabic_to_roman(self, result):
        ...
        if arabic_num//100 != 0:
            ...
            arabic_num -= count
            roman_num += self.roman_nums[count]
        if arabic_num//10 != 0:
            count = arabic_num//10*10
            arabic_num -= count
            roman_num += self.roman_nums[count]
        if arabic_num > 0:
            roman_num += self.roman_nums[arabic_num]
    ...
    def binds(self):
        ...
        num_binds = {"I":1,"II":2,"III":3,"IV":4,"V": 5,"VI":6,"VII":7,"VII":8,"IX":9,"X":10} 
        for key in num_binds:
            self.root.bind(num_binds[key], lambda e, operator = key: self.add_to_expression(operator))
